...
import { AnimatedCard, AnimatedStagger, AnimatedStaggerItem } from "./page-animations"
  ...
  return (
    <section className="w-full bg-[#f5f5f5] pt-16 pb-10 sm:pt-20 sm:pb-14 md:pt-32 md:pb-0 lg:px-4">
      <div className="container flex flex-col items-center gap-6 text-center sm:gap-8 md:gap-10">
        <AnimatedStagger
          className="flex w-full max-w-xl flex-col gap-3 sm:gap-4 md:max-w-4xl md:gap-6"
          stagger={0.18}
          delayChildren={0.05}
          viewportAmount={0.35}
        >
        ...
        <AnimatedStagger
          className="flex w-full max-w-md flex-wrap items-center justify-center gap-3 sm:max-w-lg sm:gap-6 md:max-w-2xl"
          stagger={0.16}
          delayChildren={0.12}
          viewportAmount={0.3}
        >
        ...
        <div className="w-full px-4 pt-6 sm:px-0">
          <AnimatedCard className="relative mx-auto w-full max-w-md overflow-hidden rounded-t-3xl border border-white/70 bg-white sm:max-w-3xl md:max-w-5xl lg:max-w-6xl lg:rounded-t-[36px]">
            <Image
